...
# ============================================================
# ÍNDICES DE GENTRIFICACIÓN POR ALCALDÍA (proporcionados por el usuario)
# ============================================================
...
def preparar_sistema():
    ...
    df["gentrification_index"] = df["gentrification_index"].fillna(0.5)  # fallback
...
# INSTANCIACIÓN
# ============================================================
_ya_cargado = "sistema_rentas_listo" in st.session_state

if not _ya_cargado:
    with st.spinner("⏳ Cargando modelo de rentas — solo ocurre una vez..."):
        (
    ...
    st.session_state["sistema_rentas_listo"] = True
else:
    (
        MODELS, IMPUTERS, SEGMENTADORES,
        STATIC_FEATURES, FEATURES_ALL,
