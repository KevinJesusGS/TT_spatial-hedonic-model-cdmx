...
with _nav_col2:
    ...
    <div style="text-align:center;padding:0.35rem 0;font-size:0.82rem;
        ...
        📍 Módulo activo: <b>🏢 Compra / Venta</b> &nbsp;·&nbsp; 
        <a href="javascript:void(0)" onclick="window.parent.postMessage({type:'streamlit:setComponentValue',value:'rentas'},'*')" 
           style="color:inherit;">🏘️ Rentas</a> &nbsp;·&nbsp;
        🏠 Airbnb
    </div>
...
PATH_QGIS_DATA = os.path.join(PROJECT_ROOT, "..", "..", "..", "outputs", "results", "resultados_qgis_final.csv")
...
# INSTANCIACIÓN
# ============================================================
# Agregar cerca del inicio, después del CSS:
_ya_cargado = "sistema_cv_listo" in st.session_state

if not _ya_cargado:
    with st.spinner("⏳ Cargando modelo de Compra/Venta — solo ocurre una vez..."):
       (
    MODELS, IMPUTERS,
    ...
    st.session_state["sistema_cv_listo"] = True
else:
    (
    MODELS, IMPUTERS,
    KMEANS_MODELS, CLUSTER_SCALERS, CLUSTER_FEAT_BY_SEG,
